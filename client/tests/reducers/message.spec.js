...
describe('Message Reducer', () => {
  ...
  it('should update the state when ARCHIVE_MESSAGES_BEGINS is passed', () => {
    ...
    const newState = MessageReducers.archiveMessageReducer(initialState, action);
    expect(newState).toEqual(expected);
  });
  ...
  it('should update the state when ARCHIVE_MESSAGES_UNSUCCESSFUL is passed', () => {
    const action = {
      type: 'ARCHIVE_MESSAGES_UNSUCCESSFUL', message: 'Read messages could not be archived'
    };
    const expected = {
      loading: false,
  ...
  it('should update the state when GET_ARCHIVE_MESSAGES_SUCCESSFUL is passed', () => {
    const action = {
      type: 'GET_ARCHIVE_MESSAGES_SUCCESSFUL', payload: [{ message: 'message archived', postedby: 'kola' }]
    };
    const expected = {
      loading: false,
      responseMsg: '',
  ...
  it('should update the state when GET_ARCHIVE_MESSAGES_UNSUCCESSFUL is passed', () => {
    const action = {
      type: 'GET_ARCHIVE_MESSAGES_UNSUCCESSFUL', payload: 'could not get archived messages'
    };
    const expected = {
      loading: false,
  ...
  it('should update the state when GET_ARCHIVE_MESSAGES_REJECTED is passed', () => {
    const action = {
      type: 'GET_ARCHIVE_MESSAGES_REJECTED'
    };
    const expected = {
      loading: false,
      responseMsg: '',
